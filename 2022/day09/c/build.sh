...
clear
rm "$script_root/day09.out"
clang \
    -I "$script_root/../../../helpers/c/" \
    -Wno-format-extra-args -Wall -Werror \
    "$script_root/day09.c" "$script_root/../../../helpers/c/helpers.c" \
    -o "$script_root/day09.out"

CYAN=$'\033[1;36m'
DARKGRAY=$'\033[1;30m'
NO_COLOUR=$'\033[0m'
echo "${CYAN}Testing simple input...${NO_COLOUR}"
"$script_root/day09.out" "$script_root/day09_simple.txt"
...
then
    ...
    "$script_root/day09.out" "$script_root/day09_real.txt"
    echo "${DARKGRAY}...done${NO_COLOUR}"
fi
